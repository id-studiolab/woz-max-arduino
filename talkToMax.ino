...
int D5_value = 0;
int D6_value = 0;
int LED1_color[3] = {0, 0, 0};
int LED2_color[3] = {0, 0, 0};
int LED3_color[3] = {0, 0, 0};
int LED4_color[3] = {0, 0, 0};
int A0_value = 0;
int A1_value = 0;
int A2_value = 0;
int A3_value = 0;
...
void ShowCommands()
{
  ...
  Serial.println(" 1  <value> - sensor sampling interval (in milliseconds)");
  Serial.println(" 2  <value> - Set D2 state 0 = LOW, 1 = HIGH");
  Serial.println(" 3  <value> - Set D3 PWM value 0 - 255");
  Serial.println(" 4  <value> - Set D4 state 0 = LOW, 1 = HIGH");
  Serial.println(" 5  <value> - Set D5 PWM value 0 - 255");
  Serial.println(" 6  <value> - Set D6 PWM value 0 - 255");
  Serial.println(" 7  <red-value> <green-value> <blue-value> - Set LED1 color, values 0 - 255");
  Serial.println(" 8  <red-value> <green-value> <blue-value> - Set LED2 color, values 0 - 255");
  Serial.println(" 9  <red-value> <green-value> <blue-value> - Set LED3 color, values 0 - 255");
  Serial.println(" 10 <red-value> <green-value> <blue-value> - Set LED4 color, values 0 - 255");
}
...
void OnSetActuator()
{
  ...
  switch (cmd) {
    ...
    case kD4:
      D4_value = value;
#ifdef DEBUG
      Serial.print("D4_value: ");
      Serial.println(D4_value);
#endif
      break;
    case kD5:
#ifdef DEBUG
      Serial.print("D5_value: ");
