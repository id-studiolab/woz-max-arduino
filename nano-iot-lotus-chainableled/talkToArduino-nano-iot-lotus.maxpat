...
, 							{
								"box" : 								{
									...
									"id" : "obj-38",
									"items" : [ "Select a port", ",", "SOC", ",", "MALS", ",", "StefansiPhone-Wirelessi", ",", "Bluetooth-Incoming-Port", ",", "UEBOOM-LWACP", ",", "AdriaansiPhoneX-Wireles", ",", "Refresh menu" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
